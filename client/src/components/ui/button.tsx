    ...
    variants: {
      variant: {
        ...
        outline:
          ...
          "border bg-card/70 [border-color:var(--button-outline)] shadow-xs hover:bg-card active:shadow-none",
        secondary: "bg-secondary text-secondary-foreground border border-secondary-border hover:brightness-105",
        // Add a transparent border so that when someone toggles a border on later, it doesn't shift layout/size.
        ghost: "border border-transparent hover:bg-muted/75",
      },
